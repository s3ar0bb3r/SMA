<div class="head">
    <nav class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand">Tuition Fees({{$total}})</a>
        </div>
        <div>
            <div class="navbar-form navbar-right" role="search">
                ...
                <button type="button" class="btn btn-default btn-sm tool-icon take-fee" title="Take Tuition Fee">
    ...
    <table class="table">
        ...
        <?php $fees->each(function($fee){ ?>
            <tr class="active">
                ...
                <td><?php echo $fee->student->student_unique_id; ?></td>
